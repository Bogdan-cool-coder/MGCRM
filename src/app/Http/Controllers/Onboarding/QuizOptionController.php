...
class QuizOptionController extends Controller
{
     ...
     */
    public function index(Request $request, QuizQuestion $question): AnonymousResourceCollection
    {
     ...
     */
    public function store(StoreQuizOptionRequest $request, QuizQuestion $question): JsonResponse
    {
     ...
     */
    public function update(UpdateQuizOptionRequest $request, QuizOption $option): JsonResource
    {
     ...
     */
    public function destroy(Request $request, QuizOption $option): JsonResponse
    {
     ...
     */
    public function reorder(ReorderRequest $request, QuizQuestion $question): AnonymousResourceCollection
    {

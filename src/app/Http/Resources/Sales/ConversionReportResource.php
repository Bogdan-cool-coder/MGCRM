...
/**
 * ConversionReportResource — GET /api/reports/conversions (R5, contract §6.8).
 * Wraps the array returned by ConversionReportService::build().
 *
 * Per-class $wrap = null (same pattern as the other Sales Analytics reports)
 * so meta/custom/stage appear directly at the response root.
 */

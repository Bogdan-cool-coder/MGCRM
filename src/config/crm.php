...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Single threshold for the score_pct badge in the manager cabinet
    | (ManagerKpiService::scoreBadge). Three bands derived from one value:
    |   pct >= 100                   → 'success'
    |   warning_threshold..99        → 'warning'
    |   below warning_threshold      → 'danger' (fallthrough)
    |
    */
    'kpi' => [

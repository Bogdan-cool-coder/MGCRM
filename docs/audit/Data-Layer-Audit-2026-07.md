...
### Д1 — «гонки и путаница» (все 12 high + смежные med того же файла)
...
## 5. Метрики до/после (скелет — заполняется в Д4)

> Замеры снимаются в Chrome DevTools MCP на `localhost:5173`, по 3 прогона, медиана. Тайминги «до» — до старта Д1.

| Сценарий | Метрика | До | После Д1 | После Д3 | Цель |
|---|---|---|---|---|---|
| Открытие карточки контакта | запросов / TTI | — | — | — | ≤ базовые запросы, TTI ↓ |
| Заметка на карточке контакта | лишних запросов / мигание | ~10 / есть | — | — | 0–1 / нет мигания |
| Заметка на карточке компании | лишних запросов / мигание | ~10 / есть | — | — | 0–1 / нет мигания |
| Kanban: свой drag | reload доски / мигание | 1 full / есть | — | — | 0 / нет |
| Kanban: событие коллеги | reload доски | 1 full | — | — | тихий частичный |
| Список контактов (scope=All) | вес payload / время | — | — | — | payload ↓, время ↓ |
| Список компаний | вес payload | — | — | — | payload ↓ |
| Инбокс список (50) | вес payload | — | — | — | payload ↓ |
| `/deals/kpi` | кол-во SQL | 7 COUNT | — | 1 aggregate | 1 |
| `/contacts/kpi` | кол-во SQL | 6 COUNT + hasColumn | — | 1 aggregate | 1 |
| Поиск по deals/companies | время (с pg_trgm) | — | — | — | ↓ |
| Дашборд Обзор | SQL / кэш-хит | ~8 без кэша | — | — | кэш-хит |
| MyTasks: N заходов | накопленных подписок | N | 1 | — | 1 |

> Переход Контакты↔Компании, свежесть после админ-правок справочников, потеря доп-полей — проверяются **функционально** (пользовательский сценарий воспроизводится/не воспроизводится), а не таймингом.

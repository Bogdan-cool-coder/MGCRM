...
# ---------------------------------------------------------------------------
# Application storage (storage/app is a named volume in the new GHCR-based
# setup; initialise the expected subdirectories when the volume is empty).
# ---------------------------------------------------------------------------
...
# `public` (e.g. company branding logos) are served via APP_URL/storage.
...
# Runs as root (php:8.3-fpm default), then php-fpm drops to www-data.
# ---------------------------------------------------------------------------

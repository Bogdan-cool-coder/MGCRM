...
import type { FinVendorBillStatus } from "@/lib/types";

const STATUS_META: Record<FinVendorBillStatus, { label: string; classes: string }> = {
  draft: {
    label: "Черновик",
...
export function VendorBillStatusBadge({ status }: Props) {

<template>
  <div class="deal-docs-tab">
    <!-- Header row -->
    <div class="deal-docs-tab__header d-flex justify-content-between align-items-center mb-3">
      <span class="fw-semibold text-muted" style="font-size: 0.85rem;">
        {{ t('sales.deal.page.tabs.documents') }}
      </span>
      <Button
        icon="pi pi-plus"
    ...
    >
      ...
      <template #empty>
        <div class="deal-docs-tab__empty">
          <i class="pi pi-file-edit deal-docs-tab__empty-icon" />

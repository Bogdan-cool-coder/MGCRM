<template>
  <div class="dir-tab-custom-fields">
    ...
    <div class="dir-tab-body">
      <CustomFieldsPage ref="pageRef" :embedded="true" :edit-mode="editing" />
    </div>
  </div>
</template>
...
import CustomFieldsPage from '@/pages/CustomFieldsPage/index.vue'

const { t } = useI18n()

const pageRef = ref<InstanceType<typeof CustomFieldsPage> | null>(null)
const editing = ref(false)
</script>

<style lang="scss" scoped>
.dir-tab-custom-fields {
  display: flex;

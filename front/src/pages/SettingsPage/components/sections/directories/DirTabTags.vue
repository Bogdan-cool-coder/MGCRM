<template>
  <div class="dir-tab-tags">
    ...
    <div class="dir-tab-body">
      <TagsPage ref="pageRef" :embedded="true" :edit-mode="editing" />
    </div>
  </div>
</template>
...
import TagsPage from '@/pages/TagsPage/index.vue'

const { t } = useI18n()

const pageRef = ref<InstanceType<typeof TagsPage> | null>(null)

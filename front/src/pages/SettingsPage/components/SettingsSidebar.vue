...
const GROUPS: SettingsGroup[] = [
  ...
  },
  {
    ...
    adminOnly: true,
    sections: [
      { key: 'countries',       labelKey: 'settings.sections.countries.title',       icon: 'pi pi-globe',       phase: 2, roles: ['admin', 'director'] },
      { key: 'acq-channels',    labelKey: 'settings.sections.acq-channels.title',    icon: 'pi pi-megaphone',   phase: 2, roles: ['admin', 'director'] },
      { key: 'disc-reasons',    labelKey: 'settings.sections.disc-reasons.title',    icon: 'pi pi-ban',         phase: 2, roles: ['admin', 'director'] },
      { key: 'catalog',         labelKey: 'settings.sections.catalog.title',         icon: 'pi pi-box',         phase: 2, roles: ['admin', 'director'] },
      { key: 'exchange-rates',  labelKey: 'settings.sections.exchange-rates.title',  icon: 'pi pi-dollar',      phase: 2, roles: ['admin', 'director'] },

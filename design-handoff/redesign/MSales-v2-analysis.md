...
**Источник:** оригинальный дизайн-бриф заархивирован **вне репозитория** — `~/Documents/MSales 2.0 дизайн-бриф/` (конфиденциально, в репозиторий не коммитится; этот дайджест — представление брифа внутри репо).

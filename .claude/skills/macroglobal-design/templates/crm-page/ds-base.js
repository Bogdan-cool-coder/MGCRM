...
(() => {
  const base = '../..';
  for (const p of ["tokens/fonts.css","tokens/colors.css","tokens/typography.css","tokens/spacing.css","tokens/semantic.css","tokens/base.css","tokens/dark.css","tokens/logical.css","styles.css"]) {
